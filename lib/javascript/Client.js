...
function eapearson_customInputDev(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.validate_custom_input = function (workspace, param1, param2, _callback, _errorCallback) {
        if (typeof workspace === 'function')
            throw 'Argument workspace can not be a function';
        if (typeof param1 === 'function')
            throw 'Argument param1 can not be a function';
        if (typeof param2 === 'function')
            throw 'Argument param2 can not be a function';
        ...
        return json_call_ajax(_url, "eapearson_customInputDev.validate_custom_input",
            [workspace, param1, param2], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "eapearson_customInputDev.status",
