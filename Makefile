SERVICE = eapearson_custominputdev
SERVICE_CAPS = eapearson_customInputDev
SPEC_FILE = eapearson_customInputDev.spec
URL = https://kbase.us/services/eapearson_custominputdev
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
